...
export function GratzPage({ handleModal }: GratzPageProps) {
  ...
  return (
    <>
      <h3 className="colored text-4xl mt-6 mb-6 text-center sm:text-6xl">
        Felicitaciones!
      </h3>
      <div className="flex flex-col h-full justify-around items-center">
        <div className="flex flex-col">
          <span className="subtitle m-1 font-normal p-0">
            Excelente! Completaste el formulario{' '}
            <span className="text-green-600 font-medium">correctamente!</span>.{' '}
          </span>
          <span className="subtitle m-1 font-normal p-0">
            Deseas ver los resultados parciales de la encuesta?{' '}
          </span>
          <span className="subtitle m-1 font-normal p-0">
            Puedes realizarla nuevamente, si lo deseas
          </span>
        </div>
